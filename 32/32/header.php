...
<head>
    ...
    <title>Dr. Ahmed Mostofa Noman - Pabna</title>
        ...
        <div class="flex items-center justify-between h-20">
            ...
            <div class="flex-shrink-0 mr-4">
                <a href="index.php" class="text-white block">
                    ...
                    <p class="text-[10px] sm:text-xs text-yellow-300 font-bold tracking-widest whitespace-nowrap" data-key="hero.subtitle">পাবনার মানুষের জন্য</p>
                </a>
            </div>
