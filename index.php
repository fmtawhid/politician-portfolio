...
<section class="bg-[#00523A] text-white py-16 md:py-24 px-4 overflow-hidden">
    <div class="container mx-auto grid md:grid-cols-2 items-center gap-12 lg:gap-20">
        ...
        <div class="order-2 md:order-1 text-center md:text-left">
            <!-- Big Title -->
            <h1 class="text-6xl md:text-8xl lg:text-[4rem] font-black leading-none tracking-tighter text-white mb-2" 
                data-key="hero.title">
                ডাঃ আহমেদ মোস্তফা নোমান  </h1>
            ...
            <p class="text-lg md:text-xl lg:text-2xl max-w-xl mx-auto md:mx-0 leading-relaxed mt-8 font-medium text-gray-100" 
               data-key="hero.intro">
                আসন্ন পাবনা পৌরসভা নির্বাচনে পাবনার তরুণ প্রজন্মের আইকন ও গণমানুষের নেতা ডাঃ আহমেদ মোস্তফা নোমান মেয়র পদপ্রার্থী আপনাদের সকলের দোয়া ও সমর্থন প্রত্যাশীীবনযাত্রার মান উন্নয়ন করতে এবং সবার জন্য সুযোগ তৈরি করতে।
            </p>
        </div>
    ...
    <div class="container mx-auto grid md:grid-cols-2 gap-x-16 gap-y-12 items-center">
        ...
        <div class="order-2 md:order-1">
            <h2 class="text-5xl md:text-6xl font-black text-[#00523A] mb-8" data-key="meet.heading">
                ডাঃ আহমেদ মোস্তফা নোমান সাথে পরিচিত হন
            </h2>
            
            <div class="border-l-8 border-yellow-400 pl-6 sm:pl-8">
                <p class="text-lg md:text-xl leading-relaxed text-gray-700 text-justify" data-key="meet.body">
                    ডাঃ আহমেদ মোস্তফা নোমান </p>
            </div>

            <div class="mt-8 pl-8">
                <p class="font-bold text-[#00523A] text-lg">
                    — <span class="bn-text">ডাঃ আহমেদ মোস্তফা নোমান  <span class="en-text hidden">Dr. Ahmed Mostofa Noman </span>
                </p>
            </div>
        </div>
    ...
    <div class="container mx-auto">
        ...
        <div class="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20 max-w-6xl mx-auto">
            ...
            <div class="lg:w-1/2 text-center lg:text-left space-y-6 order-1">
                ...
                <!-- Big CTA Button -->
                <div class="pt-4">
                    <a href="https://www.facebook.com/ahmedmostofanoman" target="_blank" class="inline-flex items-center gap-3 bg-blue-600 text-white font-bold py-4 px-8 rounded-lg hover:bg-blue-700 transition-all transform hover:scale-105 shadow-lg">
            ...
            <div class="lg:w-1/2 w-full flex justify-center lg:justify-end order-2">
                <div class="bg-white p-2 rounded-xl shadow-2xl border border-gray-200 w-[340px] md:w-[500px]">
                    <div id="fb-root"></div>
                    <div class="fb-page" 
                         data-href="https://www.facebook.com/ahmedmostofanoman" 
                         data-tabs="timeline" 
                         data-width="500" 
                         data-height="600" 
